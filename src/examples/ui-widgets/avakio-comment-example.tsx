...
export function AvakioCommentExample() {
  ...
  return (
    <div className="avakio-comment-demo-container" data-admin-theme={theme}>
          ...
          rows={[
            <div key="methods" style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', justifyContent: 'center' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', minWidth: 180 }}>
                <AvakioButton theme={theme as any} onClick={() => commentRef.current?.focus()}>
                  focus()
                </AvakioButton>
                <AvakioButton theme={theme as any} onClick={() => {
                ...
                <AvakioButton theme={theme as any} onClick={() => commentRef.current?.clear()}>
                  clear()
                </AvakioButton>
                <AvakioButton theme={theme as any} onClick={() => commentRef.current?.enable()}>
                  enable()
                </AvakioButton>
                <AvakioButton theme={theme as any} onClick={() => commentRef.current?.disable()}>
                  disable()
                </AvakioButton>

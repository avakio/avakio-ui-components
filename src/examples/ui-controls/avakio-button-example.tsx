...
export function AvakioButtonExample() {
  ...
  const propsData: PropDoc[] = [
    ...
    { id: 8, name: 'align', type: "'left' | 'center' | 'right'", defaultValue: "'center'", description: 'Text alignment inside button' },
    { id: 9, name: 'block', type: 'boolean', defaultValue: 'false', description: 'Makes button full width' },
    { id: 10, name: 'autowidth', type: 'boolean', defaultValue: 'false', description: 'Button width fits content instead of fixed width' },
    { id: 11, name: 'loading', type: 'boolean', defaultValue: 'false', description: 'Shows loading spinner and disables button' },
    { id: 12, name: 'badge', type: 'string | number', defaultValue: 'undefined', description: 'Small badge displayed beside the label' },
    { id: 13, name: 'tooltip', type: 'string', defaultValue: 'undefined', description: 'Tooltip text shown on hover' },
    { id: 14, name: 'hotkey', type: 'string', defaultValue: 'undefined', description: 'Keyboard shortcut (e.g., "ctrl+s", "delete")' },
    { id: 15, name: 'popup', type: 'string | ReactNode', defaultValue: 'undefined', description: 'Popup menu ID or component reference' },
    { id: 16, name: 'theme', type: "'material' | 'flat' | 'compact' | 'dark' | 'ocean' | 'sunset'", defaultValue: 'undefined', description: 'Theme variant for styling' },
    
    // Form Integration
    { id: 17, name: 'name', type: 'string', defaultValue: 'undefined', description: 'Form field name attribute' },
    { id: 18, name: 'value', type: 'string', defaultValue: 'undefined', description: 'Form field value attribute' },
    { id: 19, name: 'type', type: "'button' | 'submit' | 'reset'", defaultValue: "'button'", description: 'HTML button type for form behavior' },
    
    // AvakioBaseProps - Identity
    { id: 20, name: 'id', type: 'string', defaultValue: 'undefined', description: 'Component HTML ID' },
    { id: 21, name: 'testId', type: 'string', defaultValue: 'undefined', description: 'Test ID for testing purposes' },
    { id: 22, name: 'className', type: 'string', defaultValue: "''", description: 'Additional CSS class names' },
    
    // AvakioBaseProps - State
    { id: 23, name: 'disabled', type: 'boolean', defaultValue: 'false', description: 'Whether the button is disabled' },
    { id: 24, name: 'hidden', type: 'boolean', defaultValue: 'false', description: 'Whether the component is hidden' },
    
    // AvakioBaseProps - Layout
    { id: 25, name: 'borderless', type: 'boolean', defaultValue: 'false', description: 'Removes borders and shadows' },
    { id: 26, name: 'width', type: 'number | string', defaultValue: 'undefined', description: 'Width of the component' },
    { id: 27, name: 'height', type: 'number | string', defaultValue: 'undefined', description: 'Height of the component' },
    { id: 28, name: 'minWidth', type: 'number | string', defaultValue: 'undefined', description: 'Minimum width constraint' },
    { id: 29, name: 'minHeight', type: 'number | string', defaultValue: 'undefined', description: 'Minimum height constraint' },
    { id: 30, name: 'maxWidth', type: 'number | string', defaultValue: 'undefined', description: 'Maximum width constraint' },
    { id: 31, name: 'maxHeight', type: 'number | string', defaultValue: 'undefined', description: 'Maximum height constraint' },
    { id: 32, name: 'margin', type: 'number | string | [number, number, number, number]', defaultValue: 'undefined', description: 'Margin around the component' },
    { id: 33, name: 'padding', type: 'number | string | [number, number, number, number]', defaultValue: 'undefined', description: 'Padding inside the component' },
    { id: 34, name: 'style', type: 'React.CSSProperties', defaultValue: '{}', description: 'Custom inline styles' },
  ];
